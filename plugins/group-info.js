...
try{
const msr = (await fetchJson('https://raw.githubusercontent.com/MLILA17/DML/refs/heads/main/MSG/mreply.json')).replyMsg

if (!isGroup) return reply(msr.only_gp)
if (!isAdmins) { if (!isDev) return reply(msr.you_adm),{quoted:mek }} 
if (!isBotAdmins) return reply(msr.give_adm)
const ppUrls = [
        'https://url.bwmxmd.online/Adams.hgo9hild.jpg',
        'https://url.bwmxmd.online/Adams.hgo9hild.jpg',
        'https://url.bwmxmd.online/Adams.hgo9hild.jpg',
      ];
