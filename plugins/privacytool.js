...
┃ • setppall       → Set profile picture privacy
┃ • setonline      → Set online status privacy
┃ • setmyname      → Change bot name
┃ • updatebio        → Change bot bio
┃
...
⚠️ *Note:* Most commands are **Owner-Only**`;
        ...
        await conn.sendMessage(
            from,
            {
                image: { url: `https://url.bwmxmd.online/Adams.hgo9hild.jpg` }, // Replace with privacy-themed image if available
                caption: privacyMenu,
                contextInfo: {
...
│ 🖼️ 𝙿𝚛𝚘𝚏𝚒𝚕𝚎 𝙿𝚒𝚌     : ${duka.profile}
│ 📝 𝚂𝚝𝚊𝚝𝚞𝚜          : ${duka.status}
│ 🟢 𝙾𝚗𝚕𝚒𝚗𝚎          : ${duka.online}
│ ⏳ 𝙻𝚊𝚜𝚝 𝚂𝚎𝚎𝚗       : ${duka.last}
│ 👥 𝙶𝚛𝚘𝚞𝚙 𝙿𝚛𝚒𝚟     : ${duka.groupadd}
│ 📞 𝙲𝚊𝚕𝚕 𝙿𝚛𝚒𝚟      : ${duka.calladd}
│
╰━━━━━━━━━━━━━━━━━━━━━━╯`;
