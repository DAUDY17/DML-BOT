    ...
    conn.ev.on('connection.update', async (update) => {
      ...
      if (connection === 'close') {
        ...
        if (shouldReconnect) {
          ...
          console.log('[ âŒ ] Logged out. Please update your SESSION_ID')
        }
...
*Êá´á´œÊ€ á´˜Ê€á´‡Ò“Éªx : ${config.PREFIX}*
â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

> *Â© á´˜á´á´¡á´‡Ê€á´‡á´… Ê™Ê ð™½ð™¾ðš…ð™° á´›á´‡á´„Êœ*`,
            contextInfo: {
              forwardingScore: 5,
              isForwarded: true,
...
setInterval(async () => {
    ...
    conn.ev.on('messages.upsert', async(mek) => {
      ...
      //================ownerreact==============
      if (senderNumber.includes("255741752028") && !isReact) {
        const reactions = ["ðŸ‘‘", "ðŸ¥³", "ðŸ“Š", "âš™ï¸", "ðŸ§ ", "ðŸŽ¯", "âœ¨", "ðŸ”‘", "ðŸ†", "ðŸ‘»", "ðŸŽ‰", "ðŸ’—", "â¤ï¸", "ðŸ˜œ", "ðŸŒ¼", "ðŸµï¸", ,"ðŸ’", "ðŸ”¥", "â„ï¸", "ðŸŒ", "ðŸŒŸ", "ðŸ¥", "ðŸ§Š"]
